...
const VOICE_SVG='<svg viewBox="0 0 24 24" fill="currentColor"><rect x="4" y="9" width="2.2" height="6" rx="1.1"/><rect x="9" y="5" width="2.2" height="14" rx="1.1"/><rect x="14" y="8" width="2.2" height="8" rx="1.1"/><rect x="19" y="10" width="2.2" height="4" rx="1.1"/></svg>';
...
function syncSend(){            // empty box → voice/dictate button; typing → send button (claude.ai-style)
  ...
  btn.title=empty?"Voice mode":"Send";
  btn.innerHTML=empty?VOICE_SVG:SEND_SVG;
}
